...
public class BasePageAndroid extends DriverFactory {
    ...
    public static void captureScreenshot() throws IOException {
        ...
        FileUtils.copyFile(srcFile, new File(System.getProperty("user.dir") + "/Reports/android-screenshots/" + screenshotName));
    ...
    public static String returnScreenshotName() {
        return (System.getProperty("user.dir") + "/Reports/android-screenshots/" + screenshotName);
    }
    ...
    public static void copyLatestExtentReport() throws IOException {
        ...
        File source = new File(System.getProperty("user.dir") + "/Reports/cucumber-android-reports/android-report.html");
        File dest = new File(System.getProperty("user.dir") + "/Reports/cucumber-android-reports/" + date + ".html");
