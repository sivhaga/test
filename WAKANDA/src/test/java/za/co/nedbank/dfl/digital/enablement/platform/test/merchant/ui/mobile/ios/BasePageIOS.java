...
public class BasePageIOS extends DriverFactory {
    ...
    public void clickOkButtonToAccessContact() {
        try {
            int size = driver.findElementsByAccessibilityId("OK").size();
            if (size > 0) {
    ...
    public static void captureIOSScreenshot() throws IOException, InterruptedException {
        ...
        FileUtils.copyFile(srcFile, new File(System.getProperty("user.dir") + "/target/ios-screenshot/" + screenshotName));
    ...
    public static String returnIOSScreenshotName() {
        return (System.getProperty("user.dir") + "/target/ios-screenshot/" + screenshotName);
    }
    ...
    public static void copyLatestIOSExtentReport() throws IOException {
        ...
        File source = new File(System.getProperty("user.dir") + "/target/cucumber-ios-reports/ios-report.html");
        File dest = new File(System.getProperty("user.dir") + "/target/cucumber-ios-reports/" + date + ".html");
